...
dev.off()
outresults = list(results_with_Annot = DeSeq2Results_df_annot, DeSeq2Results_df_condOnly_annot=results_per_contrast, results_per_contrast=results_per_contrast)
return(outresults)
}
